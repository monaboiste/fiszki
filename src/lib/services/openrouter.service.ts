...
// function mockAIResponse(): Promise<OpenRouterApiResponse> {
//   return Promise.resolve({
//     id: "gen-1745594515-CoIBZQLuTSoZAtMYpPEM",
...
//             flashcards: [
//               {
//                 back: "Solves the dual write problem in distributed systems, ensuring data consistency between database updates and message/event notifications.",
//                 front: "What problem does the Transactional Outbox Pattern solve?",
//               },
//               {
//                 back: "A single operation involves both a database write and a message/event notification, often leading to inconsistencies if one operation fails.",
//                 front: "What is a dual write operation?",
//               },
//               {
//                 back: "Event-driven architectures, ensuring atomicity between services, implementing event sourcing, and when data consistency is paramount.",
//                 front: "When should you use the Transactional Outbox Pattern?",
//               },
//             ],
//           }),
//           refusal: null,
